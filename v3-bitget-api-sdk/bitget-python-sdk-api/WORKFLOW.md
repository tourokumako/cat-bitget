...
| 本番ポジション | なし（BOT 停止中） |
| 次のタスク | **P4 TP率改善（TP率64%・TIME_EXIT 58件/-$527 が最大残存損失源）** |
...
| P22-SHORT | 〜8 | -$9 | — | 2件/-$44 | 件数少・影響小 |
| P23-SHORT | 114 | **+$63** | 88% | 13件/-$182 | — |
| P24-SHORT | 〜22 | -$29 | — | 3件/-$78 | 件数少・影響小 |
...
- **P23_ADX_MAX=40 で解決**: ADX 40-50（強トレンド）への逆張りが損失の主因だった。ADX 30-40 のみに絞り P23 を黒字化（-$114→+$63）。
...
| **C. スケールアップ** | ETH/SOL 追加でトレード数×3〜5倍 | エッジが正になってから（現状 $2.8/day → $100/day 基準未達） |
