...
### 直近 Replay 結果（2026-04-04 セッション3・最新）
...
| 方針 | 内容 | 期待値 |
|------|------|--------|
| **A. P23 TIME_EXIT 削減** | 残存 TIME_EXIT 119件の主体。P23 は atr フィルター未適用 | atr_14 分析 → 同様のフィルター候補 |
| **B. P4 TP率改善** | P4 TP率 64% が低い。atr>=150 に絞っても改善余地あり | 別指標での分析 |
